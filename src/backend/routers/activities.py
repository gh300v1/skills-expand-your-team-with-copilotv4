...
def get_activities(
    ...
    difficulty: Optional[Literal["All", "Beginner", "Intermediate", "Advanced"]] = None
) -> Dict[str, Any]:
    """
    ...
    - difficulty: Filter by 'Beginner', 'Intermediate', 'Advanced', or 'All' for activities without difficulty data
    """
