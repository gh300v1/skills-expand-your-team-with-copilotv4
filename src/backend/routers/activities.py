...
def get_activities(
    ...
    difficulty: Optional[Literal["unspecified", "Beginner", "Intermediate", "Advanced"]] = None
) -> Dict[str, Any]:
    """
    ...
    - difficulty: Filter by 'Beginner', 'Intermediate', 'Advanced', or 'unspecified' for activities without difficulty data
    """
