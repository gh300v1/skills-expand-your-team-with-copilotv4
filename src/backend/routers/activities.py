...
def get_activities(
    ...
    difficulty: Optional[Literal["All Levels", "Beginner", "Intermediate", "Advanced"]] = None
) -> Dict[str, Any]:
    """
    ...
    - difficulty: Filter by 'Beginner', 'Intermediate', 'Advanced', or 'All Levels' for activities without difficulty data
    """
